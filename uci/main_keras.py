...
path = r'F:\PHD\GAN\code.12.2020\PGAN1\RL_acc\RL_acc_wisdm_data.h5'
dataset = 'wisdm'
...
X_train, X_test, y_train, y_test = train_test_split(X_source, y_source, test_size=0.1, random_state=42)
p_train, p_test, p_train_onehot, p_test_onehot = train_test_split(p_source, p_onehot_source, test_size=0.1, random_state=42)
y_train_onehot, y_test_onehot = train_test_split(y_onehot_source, test_size=0.1, random_state=42)
...
gan.load_weights("F:\PHD\GAN\code.12.2020\gan_ckpt_wisdm/variables/variables")
generator_model.load_weights("F:\PHD\GAN\code.12.2020\generator_ckpt_wisdm/variables/variables")
discriminator_p_model.load_weights("F:\PHD\GAN\code.12.2020\discriminator_p_ckpt_wisdm/variables/variables")
discriminator_a_model.load_weights("F:\PHD\GAN\code.12.2020\discriminaror_a_ckpt_wisdm/variables/variables")
